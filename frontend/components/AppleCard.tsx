...
export default function AppleCard({ children, className = '', hover = true, onClick }: AppleCardProps) {
  ...
  return (
    <div className={`${base} ${hoverClasses} ${interactive} ${className}`} onClick={onClick}>
      {children}
    </div>
  )
}
