...
export default function CertificadosClient({ initialCertificates }: CertificadosClientProps) {
  ...
  const [filter, setFilter] = useState<'all' | 'fimathe' | 'specialized'>('all')
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
            <div>
              ...
              <p className="text-[#8a8a8d] mt-1">
                {filteredCertificates.length} {filteredCertificates.length === 1 ? 'credencial' : 'credenciais'}
              </p>
            </div>
