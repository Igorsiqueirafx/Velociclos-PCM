          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {certificates.map((cert) => (
              <GlassCard
                key={cert.id}
                glass="frosted"
                className="group overflow-hidden transition-all duration-300 hover:border-[#ffd700] hover:shadow-[0_0_25px_rgba(255,215,0,0.15)] cursor-pointer"
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-semibold text-[#dcdcdc] group-hover:text-[#ffd700] transition-colors">
                    {cert.title}
                  </h3>
