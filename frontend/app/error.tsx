  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <GlassCard glass="frosted" className="max-w-md w-full p-8 text-center">
        <div className="w-16 h-16 mx-auto mb-6 bg-[#0071e3]/10 rounded-full flex items-center justify-center">
        ...
        <h1 className="text-2xl font-semibold text-white mb-3">Algo deu errado</h1>
